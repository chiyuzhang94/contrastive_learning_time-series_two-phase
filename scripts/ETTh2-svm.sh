...
python -u main_informer.py --model $model --data ETTh2 --features M --e_layers $e_layers --attn prob --des 'Exp' --itr 3 --batch_size 16 --mask_rate $mask_rate --des_path $des --loss_lambda $losslambda --train_epochs $train_epoch --patience $patience --l2norm $l2norm --moco_average_pool $moco_average_pool --data_aug $data_aug --cos_lr $cos_lr --learning_rate $learning_rate --freeze_encoder $freeze_encoder --svm_evaluate $svm_evaluate --mare $mare
