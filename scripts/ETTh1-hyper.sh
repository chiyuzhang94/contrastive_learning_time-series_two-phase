...
python -u main_informer.py --model $model --data ETTh1 --features M --seq_len 48 --label_len 48 --pred_len 24 --e_layers $e_layers --d_layers 1 --attn prob --des 'Exp' --itr 3 --factor 3 --batch_size 16 --mask_rate $mask_rate --des_path $des --loss_lambda $losslambda --freq 'h' --train_epochs $train_epoch --patience $patience --l2norm $l2norm --moco_average_pool $moco_average_pool --data_aug $data_aug --cos_lr $cos_lr --learning_rate $learning_rate --freeze_encoder $freeze_encoder --mare $mare
...
python -u main_informer.py --model $model --data ETTh1 --features M --seq_len 336 --label_len 168 --pred_len 336 --e_layers $e_layers --d_layers 1 --attn prob --des 'Exp' --itr 3 --batch_size 16 --mask_rate $mask_rate --des_path $des --loss_lambda $losslambda --freq 'h' --train_epochs $train_epoch --patience $patience --l2norm $l2norm --moco_average_pool $moco_average_pool --data_aug $data_aug --cos_lr $cos_lr --learning_rate $learning_rate --freeze_encoder $freeze_encoder --mare $mare #seq_len is different to orignial informer
